...
// Base Geográfica Colombia & Internacional (Respeta Mayúsculas)
...
export default function Home() {
  ...
  // Selector Interactivo Privado de Listas de Precios
  ...
  // Datos Encabezado Pedido (Nativamente en MAYÚSCULAS)
  ...
  // Filas del Pedido B2B con precios dinámicos por lista L1-L5
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#090d16', color: '#f8fafc', padding: '15px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '1350px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        {/* CONTROLES SUPERIORES (INVISIBLES EN EL PDF DE IMPRESIÓN) */}
        ...
        {/* CONTENEDOR PRINCIPAL TAMAÑO CARTA (PRINT-OPTIMIZED) */}
        <div id="hoja-pedido-oficial" style={{ backgroundColor: '#ffffff', color: '#000000', padding: '20px', borderRadius: '12px', border: '2px solid #000000', boxSizing: 'border-box', maxWidth: '794px', margin: '0 auto', width: '100%' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 2.5fr 1.4fr', border: '2px solid #000000', marginBottom: '-2px', boxSizing: 'border-box' }}>
            ...
            <div style={{ padding: '8px', textAlign: 'center', borderRight: '2px solid #000000' }}>
              ...
              <p style={{ margin: '2px 0 0 0', fontSize: '9.5px', fontWeight: 'bold' }}>
          ...
          {/* 2. TABLA ENCABEZADO DATOS DE CLIENTE & DESPACHO CON MAYÚSCULAS NATIVAS Y EMOJIS */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', border: '2px solid #000000', fontSize: '9.5px', fontWeight: 'bold', marginBottom: '-2px', boxSizing: 'border-box', overflow: 'hidden' }}>
            <div style={{ borderRight: '2px solid #000000', boxSizing: 'border-box' }}>
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                <span style={{ width: '100px', color: '#000000' }}>👤 SEÑOR(ES)</span>
                <input value={clienteNombre} onChange={e => setClienteNombre(e.target.value.toUpperCase())} style={{ flex: 1, border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none', width: '100%', textTransform: 'uppercase' }} />
              </div>
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                <span style={{ width: '100px', color: '#000000' }}>🏪 ALMACÉN</span>
                <input value={almacen} onChange={e => setAlmacen(e.target.value.toUpperCase())} style={{ flex: 1, border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none', width: '100%', textTransform: 'uppercase' }} />
              </div>
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                <span style={{ width: '100px', color: '#000000' }}>📍 DIRECCIÓN</span>
                <input value={direccion} onChange={e => setDireccion(e.target.value.toUpperCase())} style={{ flex: 1, border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none', width: '100%', textTransform: 'uppercase' }} />
              </div>
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                <span style={{ width: '100px', color: '#000000' }}>💳 FORMA DE PAGO</span>
                <input value={formaPago} onChange={e => setFormaPago(e.target.value.toUpperCase())} style={{ flex: 1, border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none', textTransform: 'uppercase' }} />
              </div>
              ...
              <div style={{ padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '4px', alignItems: 'center', flex: 1 }}>
                  <span>INICIO:</span>
                  <input type="date" value={vigenciaInicio} onChange={e => setVigenciaInicio(e.target.value)} style={{ border: '1px solid #000000', borderRadius: '3px', color: '#dc2626', fontWeight: 'bold', padding: '1px 3px', fontSize: '8.5px', outline: 'none' }} />
                  <span>FIN:</span>
                  <input type="date" value={vigenciaFin} onChange={e => setVigenciaFin(e.target.value)} style={{ border: '1px solid #000000', borderRadius: '3px', color: '#dc2626', fontWeight: 'bold', padding: '1px 3px', fontSize: '8.5px', outline: 'none' }} />
                </div>
              </div>
            </div>
            ...
            <div style={{ boxSizing: 'border-box' }}>
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                <span style={{ width: '90px', color: '#000000' }}>🆔 NIT O C.C.</span>
                <input value={nitCliente} onChange={e => setNitCliente(e.target.value.toUpperCase())} style={{ flex: 1, border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none', textTransform: 'uppercase' }} />
              </div>
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                <span style={{ width: '75px', color: '#000000' }}>📞 TELÉFONO</span>
                <input value={telefono} onChange={e => setTelefono(e.target.value)} style={{ width: '50px', border: 'none', outline: 'none' }} />
                <span style={{ width: '60px', color: '#000000' }}>📱 CELULAR</span>
              ...
              {/* Selector de Ubicación en MAYÚSCULAS */}
              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                <span style={{ width: '90px', color: '#000000' }}>🗺️ UBICACIÓN</span>
                <select value={deptoSeleccionado} onChange={e => { setDeptoSeleccionado(e.target.value); setCiudadSeleccionada(geoColombia[e.target.value][0]); }} style={{ border: 'none', fontWeight: 'bold', color: '#dc2626', fontSize: '9px', outline: 'none', textTransform: 'uppercase' }}>
                  {Object.keys(geoColombia).map(d => <option key={d} value={d}>{d}</option>)}
                </select>
                <select value={ciudadSeleccionada} onChange={e => setCiudadSeleccionada(e.target.value)} style={{ border: 'none', fontWeight: 'bold', color: '#dc2626', fontSize: '9px', outline: 'none', textTransform: 'uppercase' }}>
                  {geoColombia[deptoSeleccionado]?.map(c => <option key={c} value={c}>{c}</option>)}
                </select>
              </div>

              <div style={{ borderBottom: '2px solid #000000', padding: '4px 6px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                <span style={{ width: '75px', color: '#000000' }}>🏷️ DESCUENTO</span>
                <input value={descuento} onChange={e => setDescuento(e.target.value)} style={{ width: '35px', border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none' }} />
                <span style={{ width: '65px', color: '#000000' }}>👤 VENDEDOR</span>
                <input value={vendedor} onChange={e => setVendedor(e.target.value.toUpperCase())} style={{ flex: 1, border: 'none', fontWeight: 'bold', color: '#dc2626', outline: 'none', textTransform: 'uppercase' }} />
              </div>

              {/* Calendario Desplegable para Corte de Facturación */}
              <div style={{ padding: '4px 6px', display: 'flex', alignItems: 'center' }}>
                <span style={{ width: '100px', color: '#000000' }}>📅 CORTE FACTURA</span>
                <input type="date" value={corteFacturacion} onChange={e => setCorteFacturacion(e.target.value)} style={{ border: '1px solid #000000', borderRadius: '3px', color: '#2563eb', fontWeight: 'bold', padding: '1px 3px', fontSize: '8.5px', outline: 'none' }} />
              </div>
            </div>
          </div>

          {/* CUADRO MULTI-RENGLÓN DE NOTAS U OBSERVACIONES */}
          <div style={{ border: '2px solid #000000', padding: '4px 6px', fontSize: '9.5px', fontWeight: 'bold', marginBottom: '10px', backgroundColor: '#f8fafc', boxSizing: 'border-box' }}>
            ...
            <textarea
              ...
              style={{ width: '100%', border: 'none', outline: 'none', backgroundColor: 'transparent', fontWeight: 'bold', color: '#dc2626', resize: 'vertical', textTransform: 'uppercase' }}
            />
          </div>

          {/* 3. MATRIZ CON ENCABEZADO VERTICAL FIJO DE TALLAS INDEPENDIENTES */}
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9px', textAlign: 'center', border: '2px solid #000000' }}>
              <thead>
                <tr style={{ backgroundColor: '#f1f5f9', borderBottom: '2px solid #000000', fontWeight: '900' }}>
                  <th style={{ padding: '3px', borderRight: '2px solid #000000', width: '25px' }} rowSpan={5}>N°</th>
                  <th style={{ padding: '3px', borderRight: '2px solid #000000', width: '55px' }} rowSpan={5}>REF</th>
                  <th style={{ padding: '3px', borderRight: '2px solid #000000', width: '130px', textAlign: 'left' }} rowSpan={5}>DESCRIPCIÓN</th>
                  ...
                  <th style={{ padding: '3px', borderRight: '2px solid #000000', width: '60px' }} rowSpan={5}>PRECIO</th>
                  <th style={{ padding: '3px', borderRight: '2px solid #000000', width: '75px' }} rowSpan={5}>VALOR TOTAL</th>
                  <th style={{ padding: '3px', width: '90px' }} rowSpan={5}>NOTA / COLOR</th>
                </tr>

                {/* FILA 1 EN CABECERA: MESES */}
                <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid #000000', fontSize: '8px', fontWeight: 'bold' }}>
                  <th style={{ borderRight: '2px solid #000000', padding: '2px', width: '55px', backgroundColor: '#f1f5f9' }}>MESES</th>
                  <th style={{ borderRight: '1px solid #000000', padding: '2px', width: '24px' }}>0-3</th>
                  <th style={{ borderRight: '1px solid #000000', padding: '2px', width: '24px' }}>3-6</th>
                  <th style={{ borderRight: '1px solid #000000', padding: '2px', width: '24px' }}>6-9</th>
                  <th style={{ borderRight: '1px solid #000000', padding: '2px', width: '24px' }}>9-12</th>
                  <th style={{ borderRight: '1px solid #000000', padding: '2px', width: '24px' }}></th>
                  <th style={{ borderRight: '1px solid #000000', padding: '2px', width: '24px' }}></th>
                  <th style={{ padding: '2px', width: '24px' }}></th>
                </tr>

                {/* FILA 2 EN CABECERA: BEBÉS */}
                <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid #000000', fontSize: '8px', fontWeight: 'bold' }}>
                  <th style={{ borderRight: '2px solid #000000', padding: '2px', width: '55px', backgroundColor: '#f1f5f9' }}>BEBÉS</th>
                ...
                {/* FILA 3 EN CABECERA: JUNIOR */}
                <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid #000000', fontSize: '8px', fontWeight: 'bold' }}>
                  <th style={{ borderRight: '2px solid #000000', padding: '2px', width: '55px', backgroundColor: '#f1f5f9' }}>JUNIOR</th>
                ...
                {/* FILA 4 EN CABECERA: JUVENIL */}
                <tr style={{ backgroundColor: '#f8fafc', borderBottom: '2px solid #000000', fontSize: '8px', fontWeight: 'bold' }}>
                  <th style={{ borderRight: '2px solid #000000', padding: '2px', width: '55px', backgroundColor: '#f1f5f9' }}>JUVENIL</th>
                ...
                {filas.map((f, idx) => {
                  ...
                  return (
                    <tr key={idx} style={{ borderBottom: '1px solid #000000' }}>
                      ...
                      <td style={{ padding: '3px', fontWeight: 'bold', borderRight: '2px solid #000000', textAlign: 'left' }}>
                        {f.descripcion}
                      </td>
                      ...
                      {/* CAJONCITOS INDEPENDIENTES PARA CADA TALLA */}
                      ...
                      {/* PRECIO UNITARIO SIEMPRE VISIBLE PARA FACTURACIÓN */}
                      <td style={{ padding: '3px', fontWeight: 'bold', borderRight: '2px solid #000000' }}>
                      ...
                      {/* CAJA DE NOTA/COLOR CON COLOR DE FONDO IMPRESO REAL */}
          ...
          <div style={{ marginTop: '15px', borderTop: '2px solid #000000', paddingTop: '10px' }}>
            <h4 style={{ fontSize: '10px', fontWeight: '900', margin: '0 0 8px 0', textTransform: 'uppercase' }}>
              📦 Resumen por Categoría · {clienteNombre}
            </h4>

            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '9px', marginBottom: '10px', border: '2px solid #000000' }}>
              <thead>
                <tr style={{ backgroundColor: '#f8fafc', borderBottom: '2px solid #000000' }}>
                  <th style={{ padding: '5px', textAlign: 'left', borderRight: '2px solid #000000' }}>Categoría</th>
                  <th style={{ padding: '5px', textAlign: 'center', borderRight: '2px solid #000000' }}>Unidades Pedidas</th>
                  <th style={{ padding: '5px', textAlign: 'right' }}>Valor Total ($ COP)</th>
                </tr>
              </thead>
              <tbody>
                {categoriasEnPedido.map((cat, cIdx) => {
                  ...
                  return (
                    <tr key={cIdx} style={{ borderBottom: '1px solid #000000' }}>
                      <td style={{ padding: '5px', fontWeight: 'bold', borderRight: '2px solid #000000' }}>{cat}</td>
                      <td style={{ padding: '5px', textAlign: 'center', fontWeight: 'bold', borderRight: '2px solid #000000' }}>{undsCat} unds</td>
                      <td style={{ padding: '5px', textAlign: 'right', fontWeight: '900', color: '#059669' }}>$ {valCat.toLocaleString('es-CO')}</td>
                    </tr>
                  );
                })}
                <tr style={{ backgroundColor: '#f1f5f9', fontWeight: '900' }}>
                  <td style={{ padding: '5px', borderRight: '2px solid #000000' }}>TOTAL GENERAL DE UNIDADES Y VALOR</td>
                  <td style={{ padding: '5px', textAlign: 'center', borderRight: '2px solid #000000' }}>{totalPrendasGeneral()} unds</td>
            ...
            <span style={{ fontSize: '9px', fontWeight: 'bold', color: '#000000', display: 'block', marginBottom: '4px' }}>
              🎯 Categorías de este pedido ({categoriasEnPedido.length} de {categoriasMaster.length} pedidas):
            </span>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(170px, 1fr))', gap: '4px', fontSize: '8px', fontWeight: 'bold' }}>
              {categoriasMaster.map((catName, mIdx) => {
                ...
                return (
                  <div key={mIdx} style={{ padding: '3px 6px', borderRadius: '3px', backgroundColor: solicitada ? '#dcfce7' : '#fee2e2', color: solicitada ? '#166534' : '#991b1b', border: `1px solid ${solicitada ? '#166534' : '#dc2626'}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
                    <span style={{ textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap' }}>
                      {solicitada ? '✓' : '✕'} {catName}
                    </span>
                    {solicitada && <span style={{ backgroundColor: '#166534', color: '#ffffff', padding: '1px 4px', borderRadius: '3px', fontSize: '7.5px' }}>{undsCat} unds</span>}
                  </div>
                );
              })}
            </div>
          ...
          {/* 5. PIE DE PÁGINA OFICIAL CON CRÉDITOS PEQUIX DIGITAL */}
          <div style={{ borderTop: '2px solid #000000', marginTop: '15px', paddingTop: '8px', textAlign: 'center', fontSize: '8.5px', color: '#475569', fontWeight: 'bold' }}>
            <p style={{ margin: 0 }}>
              🚀 Desarrollado por <strong>PEQUIX Digital</strong> · Soluciones SaaS & E-Commerce para Tiendanube y ERPs<br />
              📞 Teléfono Comercial: <strong>333 254 1133</strong> · Medellín, Colombia
            </p>
          </div>
        ...
        {modalFoto && (
          <div className="no-print" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.85)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 9999, padding: '20px' }}>
            <div style={{ backgroundColor: '#ffffff', color: '#0f172a', borderRadius: '18px', padding: '25px', maxWidth: '500px', width: '100%', display: 'flex', flexDirection: 'column', gap: '12px', relative: 'relative', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.5)' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                <span style={{ backgroundColor: '#1e3a8a', color: '#38bdf8', fontSize: '10px', fontWeight: '900', padding: '4px 10px', borderRadius: '6px' }}>
                  REFERENCIA: {modalFoto.referencia} · {modalFoto.curva}
                </span>
                <h3 style={{ fontSize: '1.2rem', fontWeight: '900', margin: '6px 0 0 0' }}>{modalFoto.descripcion}</h3>
              </div>

              {/* Contenedor Amplio para la Imagen de la Prenda */}
              <div style={{ width: '100%', height: '280px', borderRadius: '12px', overflow: 'hidden', backgroundColor: '#f1f5f9', border: '1px solid #cbd5e1' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #e2e8f0', paddingTop: '10px' }}>
                <div>
                  <span style={{ fontSize: '9px', fontWeight: 'bold', color: '#64748b', display: 'block' }}>COLORES EN STOCK:</span>
                ...
                <div style={{ textAlign: 'right' }}>
                  <span style={{ fontSize: '9px', fontWeight: 'bold', color: '#64748b' }}>PRECIO {listaActiva}:</span>
      ...
      {/* REGLAS CSS ESPECIALES PARA FORMATO IMPRESO TAMAÑO CARTA Y COLOR EXACTO */}
      <style jsx global>{`
        @media print {
          @page {
